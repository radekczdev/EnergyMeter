...
//	lcdConfig();
	...
	//				UART_OutString(buffer1);
					...
					for(a=1;a<2;a++){
						...
						//////////// 3 SEKUNDY 3 SEKUNDY 3 SEKUNDY  3 SEKUNDY    /////////////////
...
//						SysCtlDelay(10000);
						...
						sprintf((char*)&buffer1,"Faza%d (10min, odswiezenie za %d sekund):\n\r      Urms: %.2lf, Uh1: %.2lf, Uhn: %.2lf, THD U: %.2lf%%\n\r",a+1,(200-n10min)*3,Urmsvalue10min[a]/n10min,Uh1value10min[a]/n10min,Uhnvalue10min[a]/n10min,THDu10min[a]);
						UART_OutString(buffer1);
						sprintf((char*)&buffer1,"      Irms: %.2lf, Ih1: %.2lf, Ihn: %.2lf, THD I: %.2lf%%\n\r",Irmsvalue10min[a]/n10min,Ih1value10min[a]/n10min,Ihnvalue10min[a]/n10min,THDi10min[a]);
						UART_OutString(buffer1);
//						sprintf((char*)&buffer1,"      dIrms: %.4lf, dIh1: %.4lf, dIhn: %.4lf\n\r",dIrmsvalue10min[a]/n10min,dIh1value10min[a]/n10min,dIhnvalue10min[a]/n10min);
//						UART_OutString(buffer1);
//						sprintf((char*)&buffer1,"      P: %.2lf, Q: %.2lf, Ph1: %.2lf, Qh1: %.2lf, Phn: %.2lf, Qhn: %.2lf\n\r",Pvalue10min[a]/n10min,Qvalue10min[a]/n10min,Ph1value10min[a]/n10min,Qh1value10min[a]/n10min,Phnvalue10min[a]/n10min,Qhnvalue10min[a]/n10min);
//						UART_OutString(buffer1);
