...
// deklaracja zmiennych //
	...
	int16_t	tabWsp[3][5]={{0,0,0,0,0},{-6,24,34,24,-6},{0,0,0,0,0}},	// tabWsp[numer_kanalu][nr_sekwencera]
			tabWspDt[3][5]={{0,0,0,0,0},{1400,-700,0,700,-1400},{0,0,0,0,0}},
	...
	float 	Uh1value[3]={0,0,0},
			...
			skalaNapiecia=2.62*442.5,								//2.62*442.5,		//3,3V
			skalaPradu=2.86*20/7/2.45;									//2.86*20/7/2.45;		//3,3V	// /7, poniewa¿ 7 zwoi
...
//		tabdI[i]=(tabdI[i]/70-(1783*dTsekwencera));
		tabdI[i]=(tabdI[i]/70);													//-(1820*dTsekwencera));
		tabI[i]=(tabI[i]/70-(1820*dTsekwencera)); 			// dzielenie przez 70 wynika z usredniania	//1580		//2135 -3,3V
		tabU[i]=(tabU[i]/70-(1590*dTsekwencera));														//1590		//2135 -3,3V

//		 SPRAWDZENIE przesuniecia w UART
//		if(i==2&&numerProbki<200) {
//			sprintf((char*)&buffer1,"%d,%d,%d\r",tabI[i],tabU[i],tabdI[i]);
//			UART_OutString(buffer1);
//		}
//		------------------------
